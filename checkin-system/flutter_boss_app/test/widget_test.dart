...
import 'package:thanakon_box_boss/config.dart';
import 'package:thanakon_box_boss/main.dart';
import 'package:thanakon_box_boss/services/api_service.dart';
import 'package:thanakon_box_boss/services/attendance_service.dart';
import 'package:thanakon_box_boss/services/location_service.dart';
import 'package:thanakon_box_boss/widgets/app_forms.dart';

void main() {
  testWidgets('THANAKON-BOX app starts', (WidgetTester tester) async {
    await tester.pumpWidget(const ThanakonBoxBossApp());
